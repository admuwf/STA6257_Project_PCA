...
* Goal is to transform the original variables into a new set of uncorrelated variables called principal components
* Used to reduce data dimensionality to find more accurate results and identify the most important factors that contribute to overall performance.

## Literature Review (Maybe)
