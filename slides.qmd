...
Andrew Mercer, Curtis Fox, Eddie Pierce
...
* The Principal Components are used in place of the original virbales to reduce data dimensionality to find more accurate results and identify the most important factors that contribute to overall performance.
...
* PC1 is the line that is fitted to the shifted data through the origin using the maximum sum of squared distances if calculated. PC2 is then found by creating a scaled perpendicular line to the fitted line through the origin. The lines are rotated to the axis.

* The linear combination of the slope of each line is used to find the eigenvalues and eigenvectors. The proportion of each variable used to create the line is known as the loading score.
