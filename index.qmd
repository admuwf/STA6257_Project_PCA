...
| Cmp      | Completions | Numeric |
| Att      | Attempts | Numeric |
| Cmp%     | Completion Percentage | Numeric |
| Yds      | Yards | Numeric |
| TD       | Touchdowns | Numeric |
| TD%      | Touchdown Percentage | Numeric |
| Int      | Interceptions | Numeric |
| Int%     | Interception Percentage | Numeric |
| 1D       | First Downs | Numeric |
| Lng      | Longest Completion | Numeric |
| Y/A      | Yards per Attempt | Numeric |
| AY/A     | Adjusted Yards per Attempt | Numeric |
| Y/C      | Yards per Completion | Numeric |
| Y/G      | Yards per Game | Numeric |
| Rate     | Passer Rating | Numeric |
| QBR      | Quarterback Rating | Numeric |
| Sk       | Sacks | Numeric |
| Yds      | Sack Yards | Numeric |
| Sk%      | Sack Percentage | Numeric |
| NY/A     | Net Yards per Attempt | Numeric |
| ANY/A    | Adjusted Net Yards per Attempt | Numeric |
| 4QC      | Fourth Quarter Comebacks | Numeric |
| GWD      | Game-Winning Drives | Numeric |
| IAY      | Intended Air Yards | Numeric |
...
| YAC      | Yards After Catch | Numeric |
| YAC/Cmp  | Yards After Catch per Completion | Numeric |
| Bats     | Passes Batted | Numeric |
| ThAwy    | Throw Aways | Numeric |
| Spikes   | Spikes | Numeric |
| Drops    | Drops | Numeric |
| Drop%    | Drop Percentage | Numeric |
| BadTh    | Bad Throws | Numeric |
...
| Bltz     | Blitzes | Numeric |
| Hrry     | Hurries | Numeric |
| Hits     | Hits | Numeric |
| Prss     | Pressures | Numeric |
| Prss%    | Pressure Percentage | Numeric |
| Scrm     | Scrambles | Numeric |
| Yds/Scr  | Yards per Scramble | Numeric |
